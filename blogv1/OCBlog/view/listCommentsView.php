...
?>
	<div class="comment">
    	...
    	<a class="lienAdmin" href="/blog/suprimer/comment-<?= $comment['id'] ?>">Supprimer le commentaire</a>
    	<a class="lienAdmin" href="/blog/suprimer-signalement/comment-<?= $comment['id'] ?>">Enlever les signalements</a>
    </div>
<?php
}
...
for($i=1; $i<=$numberPages; $i++) //On fait notre boucle
{
     ...
     {
          echo ' <a class="lienPage" href="/blog/liste-signalement/page-'.$i.'">'.$i.'</a> ';
     }
}
